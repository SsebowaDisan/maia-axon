    ...
    <Dialog.Root open={open} onOpenChange={handleOpenChange}>
      <Dialog.Portal>
        ...
        <Dialog.Content
          ...
          className="fixed left-1/2 top-1/2 z-[100] flex h-[min(780px,calc(100vh-2rem))] w-[min(900px,calc(100vw-2rem))] -translate-x-1/2 -translate-y-1/2 flex-col overflow-hidden rounded-[34px] border border-black/[0.06] bg-panel p-6 shadow-[0_30px_80px_rgba(17,17,17,0.16)] outline-none"
