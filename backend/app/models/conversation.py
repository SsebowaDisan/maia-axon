...
class Message(Base):
    ...
    # answer model from topics actually present in the source corpus. The
    # frontend renders these as clickable chips so Library mode acts as a
    # guided learning interface, not just a Q&A endpoint.
